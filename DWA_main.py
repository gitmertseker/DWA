...
def main(filename,min_v,max_v,min_w,max_w,max_a_v,max_a_w,delta_v,delta_w,dt,n,
    ...
    while not goal_Flag:
        ...
        if show_animation:
            ...
            #     ax.add_patch(patches.Rectangle((obs_x[i]-resolution/2,obs_y[i]-resolution/2),
            #     resolution,resolution,fill=True,visible=True,color='black'))
...
heading_cost_weight = 1
heading_cost_weight = 10
obstacle_cost_weight = 1
velocity_cost_weight = 0.3
goal_region = 0.02
